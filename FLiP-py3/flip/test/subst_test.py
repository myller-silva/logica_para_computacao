...
a,b,c,d,x = list(map(Letter, 'abcdx'))  # Variable in fol_session, must rebind now
...
a,b = list(map(Variable, 'ab')) # a,b now Variable not Letter, rebind again
...
a,b = list(map(Letter, 'ab')) # a,b now Letter again
